...
55:"""
56:@task create css code and add it to the result_template making it look like that of google
...
```md
<task>
- Create CSS code and add it to the `result_template` making it look like that of Google
</task>
